<script lang="ts">
  ...
  const PATHS: Record<string, string> = {
    ...
    notes: "M6 3.5h9l3 3V20a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1zm8.5 0V7H18M8 11h7M8 14.5h7M8 18h4",
    ...
    pin: "M8 4h8l-1 5 3 3v1H6v-1l3-3-1-5zm4 9v8",
    check: "M4.5 12.5l4.5 4.5L19.5 6.5",
    review: "M4 12a8 8 0 1 0 2.3-5.7L4 8.5M4 4v4.5h4.5",
    ...
    link: "M10.5 13.5a4 4 0 0 0 5.7 0l2.6-2.6a4 4 0 1 0-5.7-5.7l-1.3 1.3m2.4 5.1a4 4 0 0 0-5.7 0l-2.6 2.6a4 4 0 1 0 5.7 5.7l1.3-1.3",
